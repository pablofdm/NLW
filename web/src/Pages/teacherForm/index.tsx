...
export default function TeacherForm(){
    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader title="Que íncrivel que você quer dar aulas." description="O primeiro passo é preencher esse formulário de inscrição"/>
            <main>
             <form onSubmit={handleCreateClass}>
                ...
                <fieldset>
                    ...
                    options={[
                        ...
                        {value: 'Educação Física', label: 'Física'},
